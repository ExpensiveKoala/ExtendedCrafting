        ...
        if (world != null) {
            if (this.running) {
                ...
                if (this.recipe == null || !this.recipe.matches(recipeInventory, world)) {
                    ITableRecipe recipe = world.getRecipeManager().getRecipe(RecipeTypes.TABLE, recipeInventory, world).orElse(null);
